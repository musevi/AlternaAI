...
async function generateAltText(imageSrc, container, index) {
  try {
    ...
    // Check if a feedback container already exists
    let feedbackContainer = container.querySelector(".feedback-container");
    ...
    if (!feedbackContainer) {
      ...
      feedbackInput.placeholder =
        'Example: "Make it more concise" or "Focus more on the subject\'s expression" or "Include the color of the car"';
      ...
      // Add the feedback container to the main container
      container.appendChild(feedbackContainer);
    } else {
      // If it already exists, make sure it's clean (no error messages)
      // and reset the textarea
      ...
      const errorMsg = feedbackContainer.querySelector(
